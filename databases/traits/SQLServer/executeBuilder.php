...
namespace configDb\traits\SQLServer;

use configDb\traits\IExecuteBuilder;
use Databeses\dbConnection\SQLServer\DBConnection as DBConnectionSQLServer;
...
//    }
    ...
    function ExecuteQuery($sql, $where, $values, $bindingValues, $orderby, $limit)
    {
        ...
        $finalQuery .= " ; ";
        $dbConnection = new CreateDBConnection(new DBConnectionSQLServer());
    }
}